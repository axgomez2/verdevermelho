        ...
        <div class="p-4 bg-white border border-gray-200 rounded-lg shadow-sm">
            <form action="{{ route('admin.playlists.update', $playlist) }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="flex items-center justify-end space-x-4">
                    ...
                    <a href="{{ route('admin.playlists.edit_tracks', $playlist) }}" class="text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5">
                        {{ __('Editar Faixas') }}
                    </a>
