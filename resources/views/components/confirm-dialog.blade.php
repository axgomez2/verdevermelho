...
<div x-data="confirmDialog"
    ...
    <div x-show="show"
         ...
         class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg mx-auto mt-[10vh]">
