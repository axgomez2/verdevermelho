        ...
        <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
            <div class="mb-6">
                <div class="flex items-center justify-between">
                    <h1 class="text-2xl font-semibold text-gray-900 sm:text-3xl">Editar Endereço</h1>
            ...
            <div class="bg-white rounded-lg border border-gray-200 shadow-sm p-4 sm:p-6">
                <form action="{{ route('site.profile.addresses.update', $address) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                        <div class="sm:col-span-2">
                            ...
                            <select id="type" name="type" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5">
                                <option value="Residencial" {{ (old('type', $address->type) == 'Residencial') ? 'selected' : '' }}>Residencial</option>
                                <option value="Comercial" {{ (old('type', $address->type) == 'Comercial') ? 'selected' : '' }}>Comercial</option>
                                <option value="Outro" {{ (old('type', $address->type) == 'Outro') ? 'selected' : '' }}>Outro</option>
                            </select>
                            @error('type')
                        ...
                        <div class="sm:col-span-1">
                            ...
                            <input type="text" name="zip_code" id="zip_code" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5" placeholder="00000-000" value="{{ old('zip_code', substr_replace($address->zip_code, '-', 5, 0)) }}" maxlength="9" required>
                            @error('zip_code')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <input type="text" name="street" id="street" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5" placeholder="Nome da rua" value="{{ old('street', $address->street) }}" required>
                            @error('street')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="sm:col-span-1">
                            ...
                            <input type="text" name="number" id="number" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5" placeholder="Número" value="{{ old('number', $address->number) }}" required>
                            @error('number')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="sm:col-span-1">
                            ...
                            <input type="text" name="complement" id="complement" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5" placeholder="Apto, bloco, etc." value="{{ old('complement', $address->complement) }}">
                            @error('complement')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <input type="text" name="neighborhood" id="neighborhood" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5" placeholder="Bairro" value="{{ old('neighborhood', $address->neighborhood) }}" required>
                            @error('neighborhood')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="sm:col-span-1">
                            ...
                            <input type="text" name="city" id="city" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5" placeholder="Cidade" value="{{ old('city', $address->city) }}" required>
                            @error('city')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="sm:col-span-2">
                            <div class="flex items-center">
                                <input id="is_default" name="is_default" type="checkbox" value="1" {{ (old('is_default', $address->is_default) ? 'checked' : '') }} class="w-4 h-4 text-primary-600 bg-gray-100 border-gray-300 rounded focus:ring-primary-500">
