<x-app-layout>
    <div class="container mx-auto px-4 py-8">
        <h1 class="text-3xl font-bold mb-6">DJ Charts</h1>
            ...
            @foreach($djs as $dj)
                <div class="bg-white shadow-md rounded-lg overflow-hidden">
                    ...
                    <div class="p-4">
                        ...
                        <h4 class="text-lg font-semibold mb-2">Top 3 Recomendações:</h4>
                        <ul class="list-disc list-inside mb-4">
                            @foreach($dj->recommendations->take(3) as $recommendation)
                                <li>{{ $recommendation->title }}</li>
                            @endforeach
                        </ul>
                        <a href="{{ route('site.djcharts.show', $dj->slug) }}" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">Ver Todas as Recomendações</a>
                    </div>
                </div>
            @endforeach
        </div>
